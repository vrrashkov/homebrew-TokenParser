class Tokenparser < Formula
  ...
  version "3.2.0,v3.2.0-ci"
  if Hardware::CPU.intel?
    url "https://github.com/vrrashkov/TokenParser/releases/download/#{version.after_comma}/design_token_parser-darwin-amd64.tar.gz"
    sha256 "3fc9f91437806542bff84538979ed35dc96106818e86d0fb734edb2e6a71992f"
  else
    url "https://github.com/vrrashkov/TokenParser/releases/download/#{version.after_comma}/design_token_parser-darwin-arm64.tar.gz"
